...
class DealCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal_category" do
    assert_difference("DealCategory.count") do
      post deal_categories_url, params: { deal_category: { category_id: @deal_category.category_id, deal_id: @deal_category.deal_id } }
    end
  ...
  test "should update deal_category" do
    patch deal_category_url(@deal_category), params: { deal_category: { category_id: @deal_category.category_id, deal_id: @deal_category.deal_id } }
